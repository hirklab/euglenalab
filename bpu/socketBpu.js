...
exports = module.exports = function (app, deps, opts, mainCallback) {
	...
	//Assert Deps
	if (app === null) {
		mainCallback(moduleName + ':need app object');

	} else if (app.script_runExperiment === null) {
		mainCallback('need app.script_runExperiment object');

	} else if (app.bpuConfig === null) {
		mainCallback('need app.bpuConfig object');
	} else if (app.bpuStatusTypes === null) {
		mainCallback('need app.bpuStatusTypes object');
	} else if (app.socketStrs === null) {
		mainCallback('need app.socketStrs object');
	} else {
