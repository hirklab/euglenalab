...
var EventKeys = ['topValue', 'rightValue', 'bottomValue', 'leftValue', 'diffuserValue', 'backlightValue', 'culturelightValue', 'ambientlightValue'];
...
var _checkEventsArray = function(eventsToRun) {
  var MaxExperimentTime = 60 * 60 * 1000; //5 minutes
