...
var myEmits     = {
	setConnection: function (sessionID) {
		app.mainView.mySocket.socket.emit('/livejoylab/#setConnection', sessionID);
	},
	...
	joinQueue:     function (data) {
		app.mainView.mySocket.socket.emit('/livejoylab/#joinQueue', data);
	},
	queuryQueue:   function (data) {
		app.mainView.mySocket.socket.emit('/livejoylab/#queuryQueue', data);
	},
	noActivity:    function (data) {
		app.mainView.mySocket.socket.emit('/livejoylab/#noActivity', data);
	},
	pingRes:       function () {
		app.mainView.mySocket.socket.emit('/livejoylab/#pingRes');
	},
};
