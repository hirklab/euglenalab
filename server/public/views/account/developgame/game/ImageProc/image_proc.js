...
function integrateWasmJS() {
  ...
  var wasmTextFile = Module['wasmTextFile'] || 'image_proc.wast';
  var wasmBinaryFile = Module['wasmBinaryFile'] || 'image_proc.wasm';
  var asmjsCodeFile = Module['asmjsCodeFile'] || 'image_proc.temp.asm.js';
...
// {{PRE_LIBRARY}}
  ...
  function __ZN2cv30createBackgroundSubtractorMOG2Eidb() {
  ...
  function __ZN2cv4lineERKNS_17_InputOutputArrayENS_6Point_IiEES4_RKNS_7Scalar_IdEEiii() {
  Module['printErr']('missing function: _ZN2cv4lineERKNS_17_InputOutputArrayENS_6Point_IiEES4_RKNS_7Scalar_IdEEiii'); abort(-1);
  }
  ...
  function __ZN2cv7noArrayEv() {
  Module['printErr']('missing function: _ZN2cv7noArrayEv'); abort(-1);
  }

  function __ZN2cv12morphologyExERKNS_11_InputArrayERKNS_12_OutputArrayEiS2_NS_6Point_IiEEiiRKNS_7Scalar_IdEE() {
  Module['printErr']('missing function: _ZN2cv12morphologyExERKNS_11_InputArrayERKNS_12_OutputArrayEiS2_NS_6Point_IiEEiiRKNS_7Scalar_IdEE'); abort(-1);
  }

  function __ZN2cv9rectangleERKNS_17_InputOutputArrayENS_6Point_IiEES4_RKNS_7Scalar_IdEEiii() {
  ...
  function __ZN2cv6String10deallocateEv() {
  ...
  function __ZN2cv7putTextERKNS_17_InputOutputArrayERKNS_6StringENS_6Point_IiEEidNS_7Scalar_IdEEiib() {
  Module['printErr']('missing function: _ZN2cv7putTextERKNS_17_InputOutputArrayERKNS_6StringENS_6Point_IiEEidNS_7Scalar_IdEEiib'); abort(-1);
  }
  ...
  function __ZNK2cv3Mat9convertToERKNS_12_OutputArrayEidd() {
  Module['printErr']('missing function: _ZNK2cv3Mat9convertToERKNS_12_OutputArrayEidd'); abort(-1);
  }

  function __ZNK2cv3Mat7reshapeEiiPKi() {
  Module['printErr']('missing function: _ZNK2cv3Mat7reshapeEiiPKi'); abort(-1);
  }
  ...
  function __ZN2cv3Mat5setToERKNS_11_InputArrayES3_() {
  Module['printErr']('missing function: _ZN2cv3Mat5setToERKNS_11_InputArrayES3_'); abort(-1);
  }
  ...
  function __ZN2cv3Mat10deallocateEv() {
  Module['printErr']('missing function: _ZN2cv3Mat10deallocateEv'); abort(-1);
  }
  ...
  Module['printErr']('missing function: _ZN2cv12findContoursERKNS_17_InputOutputArrayERKNS_12_OutputArrayEiiNS_6Point_IiEE'); abort(-1);
  }

  function __ZN2cv6String8allocateEj() {
  Module['printErr']('missing function: _ZN2cv6String8allocateEj'); abort(-1);
  }

  function __ZN2cv11setIdentityERKNS_17_InputOutputArrayERKNS_7Scalar_IdEE() {
  Module['printErr']('missing function: _ZN2cv11setIdentityERKNS_17_InputOutputArrayERKNS_7Scalar_IdEE'); abort(-1);
  }

  function __ZN2cv16MatConstIterator4seekEib() {
  Module['printErr']('missing function: _ZN2cv16MatConstIterator4seekEib'); abort(-1);
  }
...
function nullFunc_viiidddiiii(x) { Module["printErr"]("Invalid function pointer called with signature 'viiidddiiii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)");  Module["printErr"]("Build with ASSERTIONS=2 for more info.");abort(x) }
...
var real___GLOBAL__sub_I_image_proc_cpp = asm["__GLOBAL__sub_I_image_proc_cpp"]; asm["__GLOBAL__sub_I_image_proc_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
...
var real__HandleMessage = asm["_HandleMessage"]; asm["_HandleMessage"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__HandleMessage.apply(null, arguments);
};
...
var __GLOBAL__sub_I_image_proc_cpp = Module["__GLOBAL__sub_I_image_proc_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
...
var _HandleMessage = Module["_HandleMessage"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_HandleMessage"].apply(null, arguments) };
