var Stylus = function(canvasDiv) {
  ...
  this.updateDraw = function() {
    ...
    //Dynamic -
    // drawJoystickStick(me.x_evt, me.y_evt);
    // drawJoystickHead(me.x_evt, me.y_evt);

    //Text
    drawStimulusText(me.stimulus_evt);
    drawTitle();
  };
  ...
  //   context.arc(xPos, yPos, me.joyHeadRadius, 0, me.TWO_PI, true);
  //   context.fill();
  // };
  ...
  // };
  //Text
  var drawStimulusText = function(stimulus) {
    context.beginPath();
    ...
    //   txt += '0';
    // }
    context.fillText('{x=' + Math.round(stimulus.x) + ',y=' + Math.round(stimulus.y) + ',mag=' + Math.round(stimulus.mag) + '}', me.textStimulus.x, me.textStimulus.y);
  };
...
Stylus.prototype.toggleStylus = function(toggle) {
...
// Stylus.prototype.getXYFromLightValues = function(lightValues, from) {
...
Stylus.prototype.setLightValuesFromXY = function(ledsSetObj, from) {
  ...
  ledsSetObj.metaData.mag = this.stimulus_evt;
